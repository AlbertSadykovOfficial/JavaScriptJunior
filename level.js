...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    fireballMove(elem,xy,dir,count) {
        xy.x -= (dir.x - dir.x * count);
        xy.y -= (dir.y - dir.y * count);
            count *= GRID_SIZE;     // переводим клеткочное расстояние в пиксельное
            w = xy.x * GRID_SIZE;
            h = xy.y * GRID_SIZE;
        ...
        for (let i = 0; i <= count ; i++) {
            ...
            h++;
            w++;  
        let timer = setInterval(frame, 10); // рисовать каждые 10 мс
        }
                clearInterval(timer);
    }
